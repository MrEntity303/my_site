const Experience = () => {
    return (
        <section id="exp" className="min-h-screen">
            <h1 className="flex justify-center text-gray-300 text-4xl font-bold pt-24">Experience</h1>
            <div className="flex flex-col justify-start items-center pt-3">
                <div className="flex flex-col 2xl:flex-row 2xl:grid-row-1 2xl:grid-cols-2 w-3/4 bg-grayCard rounded-2xl p-5 my-5">
                    ...
                    <div className="flex flex-col 2xl:w-3/4 2xl:justify-start 2xl:items-start justify-center items-center pt-3">
                        ...
                        <a href="https://github.com/MrEntity303"><button className="border-2 border-gray-300 rounded-full font-bold hover:bg-white text-gray-300 hover:text-black bg-customGray p-3">Github</button></a>
                    </div>
                </div>
                <div className="flex flex-col justify-between 2xl:flex-row 2xl:grid-row-1 2xl:grid-cols-2 w-3/4 bg-grayCard rounded-2xl p-5">
                    <div className="flex flex-col 2xl:w-1/4 justify-center items-center">
                        <img className="bg-white w-24 sm:w-36 rounded-2xl p-2" src="..\img\logo_512x512.png" alt="logo_euroengineering" />
                    </div>
                    <div className="flex flex-col 2xl:w-3/4 2xl:justify-start 2xl:items-start justify-center items-center pt-3">
                        <h1 className="text-xl xl:text-4xl text-sky-400 font-bold">Gennaio 2025 - In Corso</h1>
                        <h2 className="text-lg text-gray-300 font-bold">Stagista</h2>
                        <p className="text-justify text-gray-300 lg:mx-16 2xl:mx-0 2xl:text-start pb-3 2xl:text-lg">Stage curricolare per conto dell'Universita' di Camerino con l'obbiettivo raccolta ed uso di dataset per l'ottimizzazione di un macchinario industriale attraverso algoritmi di Intelligenza Artificiale.<br></br>
                        ...
                        <a href="https://www.eeng.it/"><button className="border-2 border-gray-300 rounded-full font-bold hover:bg-white hover:text-black text-gray-300 bg-customGray p-3">Link</button></a>
                    </div>
                </div>
            </div>
        </section>
